    ...
    <div>
      ...
      <section className="container mx-auto py-8 md:py-12">
        <div className="rounded-2xl border border-border/60 bg-secondary/60 p-6 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Únete a nuestro programa de fidelidad para bundles exclusivos, guías de nutrición y descuentos de temporada.</p>
